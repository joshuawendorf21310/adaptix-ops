#!/usr/bin/env tsx
// ============================================================
// Adaptix Ops — Check Security Alerts (standalone)
// ============================================================
// Usage: npm run check:security
// Fetches Dependabot, code scanning, and secret scanning alerts.
// ============================================================
...
console.log(`\n[check:security] Checking ${repos.length} repos...\n`);
...
for (const repo of repos) {
  ...
  try {
    ...
    // FAIL if critical/high alerts exist
    if (
    ...
    // UNKNOWN if all APIs are inaccessible
    if (
